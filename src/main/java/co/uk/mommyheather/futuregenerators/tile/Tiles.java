...
public class Tiles {
    ...
    public static final RegistryObject<BlockEntityType<TileTurbineCasing>> turbineCasing = TILES.register("turbine_casing", () -> BlockEntityType.Builder.of(TileTurbineCasing::new, Blocks.turbineCasing.get()).build(null));
    public static final RegistryObject<BlockEntityType<TileTurbineController>> turbineController = TILES.register("turbine_controller", () -> BlockEntityType.Builder.of(TileTurbineController::new, Blocks.turbineController.get()).build(null));
